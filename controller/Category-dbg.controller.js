sap.ui.define([
	...
	return Controller.extend("MDG.Help.controller.Category", {
		// formatter : formatter,
		...
		_loadCategories: function(oEvent) {
			var bSmallScreen = this.getView().getModel("appView").getProperty("/smallScreenMode"),
				sRouteName = oEvent.getParameter("category");
